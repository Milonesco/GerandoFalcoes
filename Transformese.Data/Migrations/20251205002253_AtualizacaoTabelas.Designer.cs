...
namespace Transformese.Data.Migrations
{
    ...
    [Migration("20251205002253_AtualizacaoTabelas")]
            ...
            modelBuilder.Entity("Transformese.Domain.Entities.Funcionario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Ativo = true,
                            DataCadastro = new DateTime(2025, 12, 4, 21, 22, 52, 728, DateTimeKind.Local).AddTicks(1273),
                            DataNascimento = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EhAdministrador = true,
                            Email = "admin@admingerando.falcoes",
                            Nome = "Admin",
                            Senha = "$2a$11$ihQPNNesNKPGLz2LNeuk/.ey.5Vje8ws0xwNewqyJMtoC8/AxrQQK",
                            Sexo = "Outro",
                            Sobrenome = "Geral"
                        });
                });
