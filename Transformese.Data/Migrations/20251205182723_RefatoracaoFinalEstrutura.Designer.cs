...
namespace Transformese.Data.Migrations
{
    ...
    [Migration("20251205182723_RefatoracaoFinalEstrutura")]
    partial class RefatoracaoFinalEstrutura
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Transformese.Domain.Entities.Funcionario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Ativo = true,
                            DataCadastro = new DateTime(2025, 12, 5, 15, 27, 22, 796, DateTimeKind.Local).AddTicks(5770),
                            DataNascimento = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EhAdministrador = true,
                            Email = "admin@admingerando.falcoes",
                            Nome = "Admin",
                            Senha = "$2a$11$XvyK0jRTWnXLsmw43to1G.7rL6Y0QMAT6korVqdtKxnbNcUfYIpju",
                            Sexo = "Outro",
                            Sobrenome = "Geral"
                        });
                });
